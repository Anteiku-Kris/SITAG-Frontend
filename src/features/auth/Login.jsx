...
export const Login = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-[#F6F6F6] h-screen">
      ...
      <h2 className="text-lg font-semibold text-center mt-12 mb-6" style={{ color: "#314D4D" }}>
        Bienvenido, Buen Día!
      </h2>
      ...
      <div className="fixed bottom-0 left-0 w-full flex justify-between items-end pointer-events-none">
        <img src="/src/assets/images/hierva.png" alt="Left decoration" className="w-24 sm:w-32 md:w-40 lg:w-48" />
        <img src="/src/assets/images/hierva 2.png" alt="Right decoration" className="w-24 sm:w-32 md:w-40 lg:w-48" />
      </div>
    </div>
  );
}
